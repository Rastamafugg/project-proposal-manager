...
@Component({
  selector: 'app-municipal-cip-container',
  templateUrl: './municipal-cip-container.component.html',
  styleUrls: ['./municipal-cip-container.component.scss']
})
export class MunicipalCipContainerComponent extends UserFormComponent implements OnInit {
  CIPAction = CIPAction;
  municipalCode;
  projectNumber = null;
  version;
  ...
  saveCip(cip: CapitalInvestmentPlan) {
    if (cip.projectNumber && cip.projectNumber !== this.projectNumber) {
